...
// Pins H bridge
const int HB_FORWARD = 7; // H bridge Forward
const int HB_REVERSE = 8; // H bridge Reverse
const int HB_ENABLE = 9;  // H bridge Enable
// Inputs
const int PM_SERVO_1 = A0; // Potentiometru servo 1
const int PM_INPUT_1 = A1; // Potentiometru input 1
